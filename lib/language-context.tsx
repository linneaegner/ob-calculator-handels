...
const translations = {
  sv: {
    ...
    "footer.disclaimer": "Baserat på Handels kollektivavtal. Dubbelkolla alltid din lönespecifikation.",
  },
  en: {
    ...
    "footer.disclaimer": "Based on Handels collective agreement. Always double-check your salary statement.",
  },
}
